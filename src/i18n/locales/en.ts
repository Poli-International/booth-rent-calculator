/**
 * Poli International i18n - English (en)
 * Canonical reference dictionary for Booth Rent vs Commission Calculator V2.
 *
 * Rules enforced by scripts/check-i18n.mjs (wired into `npm run build`):
 *  - every locale must contain exactly the same key set as this file;
 *  - `{cur}` is substituted automatically by t() with the locale currency symbol;
 *  - no currency symbol may be written literally inside a value.
 */
...
export const en: Record<string, string> = {
  ...
  'dealInputs.breakEvenUndefined': 'Break-even is not reachable with the current 0% commission rate.',
  'dealInputs.weeklyRent': 'Booth Rent ({cur} / week)',
  ...
  // ── ADVANCED DEAL CONTROLS (src/App.tsx) ─────────────────────
  'advanced.toggleShow': 'Configure Advanced Sliding-Scale & Walk-In Splits',
  'advanced.toggleHide': 'Hide Advanced Commission Curves & Walk-Ins',
  ...
  'breakEven.undefined': 'Break-even is not reachable with the current 0% commission rate.',
  ...
  'breakEven.xAxisLabel': 'Monthly Gross Client Revenue ({cur})',
  'breakEven.yAxisLabel': 'Monthly Net Income ({cur})',
  ...
  // ── INCLUSIONS NAMESPACE (src/components/DealInclusions.tsx) ──
  'inclusions.secTitle': 'Included Operating Expenses',
  'inclusions.secDesc': 'Rent and commission figures mean nothing without knowing who pays for supplies, sterilisation, card fees and utilities.',
  ...
  'inclusions.utilitiesHint': 'Licensing, power, water, high-speed Wi-Fi, cleaning',
  ...
  'inclusions.monthlyCostEstimate': 'Monthly Cost ({cur})',
  'inclusions.customBadge': 'Custom',
  'inclusions.removeAria': 'Remove consumable item',
  'inclusions.perProcedureTotal': '(~{amount}/mo @ {count} procs)',

  // ── REALISTIC SPREAD NAMESPACE (src/components/RealisticMonthSpread.tsx) ──
  ...
  'realistic.avgTicket': 'Average Ticket Value ({cur})',
  ...
  'realistic.directRevenue': 'Direct Monthly Revenue ({cur})',
  ...
  // ── MATERIAL REFERENCE NAMESPACE (src/App.tsx) ───────────────
  'standards.title': 'Poli International Pro Suite & Material Reference',
  'standards.toggleHide': 'Hide Material Reference',
  'standards.toggleShow': 'View Material & Gauge Reference',
  'standards.intro': 'Designed for independent artists, tattooists, body piercing studios and professional piercers. When budgeting overheads and consumable matrices, check that your autoclaves, needles and body jewellery follow established professional practice in the jurisdiction you work in.',
  'standards.matricesTitle': 'Material & Gauge Reference',
  'standards.matTitaniumTitle': 'ASTM F-136 Titanium',
  'standards.matTitaniumDesc': 'Ti-6Al-4V ELI medical/implant grade. High biocompatibility, corrosion resistant, and widely used in established professional practice for implant-grade jewellery.',
  ...
  'standards.matGaugesDesc': 'Standardised AWG/metric matrices with internal threading or threadless press-fit geometries, as used in established professional practice.',
  ...
  'relatedTools.linkTaxDesc': "Record business expenses by category through the year, ready for your accountant.",
  ...
  'common.copyFailed': 'Could not copy to clipboard. Copy the address bar manually.',
  'common.exportCsv': 'Export CSV',
  'common.exportJson': 'Export JSON',
  'common.shareLink': 'Share Deal Link',
  'common.presets': 'Saved Presets',

  // ── MULTI-DEAL COMPARISON NAMESPACE ──────────────────────────
  ...
  'multiDeal.rentLabel': 'Weekly Rent ({cur})',
  'multiDeal.commLabel': 'Commission Cut (%)',
  'multiDeal.hybridBaseRent': 'Base Weekly Rent ({cur})',
  ...
  'multiDeal.offerA': 'Offer A: Baseline',
  'multiDeal.offerB': 'Offer B: 60/40 Split Studio',
  'multiDeal.offerC': 'Offer C: Low Rent + 15% Cut',
  'multiDeal.offerCustom': 'Offer {letter}: Custom Deal',
  'multiDeal.removeAria': 'Remove {name}',

  // ── TIERED COMMISSION NAMESPACE ──────────────────────────────
  ...
  'tiered.tier1': 'Tier 1 (Up to {cur}{amount})',
  'tiered.tier2': 'Tier 2 ({cur}{from} to {cur}{to})',
  'tiered.tier3': 'Tier 3 (Above {cur}{from})',
  'tiered.cutPct': 'Studio Cut (%)',
  'tiered.shopCutInline': '% shop cut',
  'tiered.effectiveRate': 'Blended Effective Rate: {rate}% to studio',

  // ── PRESETS & STATE SHARING NAMESPACE ────────────────────────
  ...
  // ── CUSTOM LINE-ITEM SUPPLIES NAMESPACE ─────────────────────
  ...
  'customSupplies.namePlaceholder': 'e.g. Sterile Needles & Cannulas',
  'customSupplies.costType': 'Cost Type',
  'customSupplies.fixedMonthly': 'Fixed Monthly ({cur})',
  'customSupplies.perProcedure': 'Per-Procedure Unit ({cur})',
  'customSupplies.hintFixed': 'Fixed monthly consumable',
  'customSupplies.hintPerProcedure': 'Per-procedure consumable',
  'customSupplies.monthlyCost': 'Monthly Amount ({cur})',
  'customSupplies.unitCost': 'Cost per Client / Procedure ({cur})',
  ...
  // ── STANDARD CONSUMABLES KIT SEED DATA (src/utils/calculator.ts) ──
  'kit.needlesName': 'Sterile Needles & Cannulas',
  'kit.needlesHint': 'Pre-sterilised single-use surgical piercing needles',
  'kit.glovesName': 'Nitrile Gloves & Medical Barrier Film',
  'kit.glovesHint': 'Sterile procedure gloves, barrier film, tray sleeves',
  'kit.prepName': 'Skin Antiseptic Prep & Gauze',
  'kit.prepHint': 'Skin cleansing agents and sterile woven gauze swabs',
  'kit.autoclaveName': 'Autoclave Pouches & Spore Strips',
  'kit.autoclaveHint': 'Class 4 & 5 chemical indicators and biological spore vials',

  // ── SEASONALITY & CASH FLOW NAMESPACE ───────────────────────
  'seasonality.title': 'Annual Seasonality & Time-Off Simulator',
  'seasonality.subtitle': 'Project 52-week annual cash flow, holiday downtime and the booth rent that stays payable while you are away.',
  ...
  'seasonality.rentWhileAwayAlert': 'Critical cash-flow fact: under booth rent, weekly rent stays 100% payable while you are on holiday or sick leave. You will owe {cur}{amount} in rent while earning {cur}0.',
  ...
  'seasonality.chartTitle': '12-Month Net Cash Flow Comparison',
  'seasonality.legendBoothNet': 'Booth Net',
  'seasonality.legendCommNet': 'Commission Net',
  'seasonality.legendRentAway': 'Rent While Away',
  'seasonality.weeksOffShort': '{count}w off',
  'seasonality.demand0_6': '0.6x (Very Slow)',
  'seasonality.demand0_75': '0.75x (Slow)',
  'seasonality.demand0_85': '0.85x (Quiet)',
  'seasonality.demand1_0': '1.0x (Average)',
  'seasonality.demand1_1': '1.1x (Steady)',
  'seasonality.demand1_2': '1.2x (Busy)',
  'seasonality.demand1_3': '1.3x (Holiday Surge)',
  'seasonality.demand0_8': "0.8x (Quiet)",
  'seasonality.demand0_95': "0.95x (Slightly below average)",
  'seasonality.demand1_05': "1.05x (Slightly above average)",
  'seasonality.demand1_15': "1.15x (Strong)",
  'seasonality.weeksOff0': '0 weeks',
  'seasonality.weeksOff1': '1 week',
  'seasonality.weeksOff2': '2 weeks',
  'seasonality.weeksOff3': '3 weeks',
  'seasonality.weeksOff4': '4 weeks (Full month off)',

  // ── TAX & SELF-EMPLOYMENT OVERLAY NAMESPACE ─────────────────
  ...
  'tax.regimeUk': 'UK Self-Employed Sole Trader (HMRC, estimated bands)',
  'tax.regimeUs': 'US Independent Contractor / Self-Employed (1099, estimated bands)',
  ...
  'tax.effectiveTaxInline': '{rate}% Effective Tax',
  'tax.rateLabel': 'Rate:',
  'tax.inactiveTitle': 'Tax & Take-Home Overlay is currently inactive',
  'tax.inactiveDesc': 'Enable to preview spendable cash in pocket after deducting UK sole trader income tax or US self-employment tax.',
  'tax.shieldBenefit': 'Tax-shielding impact of booth rent: deducting fixed booth rent lowers your taxable profit by {cur}{amount}/year compared to commission arrangements.',
  ...
  'studio.newStation': 'Station {number} (New Station)',
  'studio.overheadTitle': 'Studio Fixed Monthly Overhead',
  'studio.overheadHint': 'Commercial lease rent, business rates, commercial insurance, receptionist/front desk salary, software licences, waste contracts.',
  'studio.overheadShortHint': 'Lease, rates, insurance, staff',
  'studio.monthlyOverhead': 'Total Monthly Overhead ({cur})',
  ...
  'studio.stationGrossRev': 'Station Monthly Gross ({cur})',
  ...
  'studio.emptyChairCost': 'Cost of 1 vacant chair: ~{cur}{amount}/month in lost studio contribution',
  'studio.revenueFromActive': 'From active chairs/splits',
  'studio.monthlyMargin': 'Monthly shop margin',
  'studio.occupancyBreakEven': 'Occupancy Break-Even',
  'studio.chairsCount': '{count} of {total} chairs',
  'studio.requiredForRent': 'Required to pay shop rent',
  'studio.rentLabel': 'Rent:',
  'studio.cutLabel': 'Cut:',
  'studio.revLabel': 'Rev:',
  'studio.zeroStation': 'Station generating {cur}0',
  'studio.removeAria': 'Delete {name}',
  ...
  'hybrid.floor': 'Minimum Guarantee (Commission with Studio Floor)',
  'hybrid.baseRent': 'Base Weekly Rent ({cur})',
  ...
  'hybrid.floorMinWeekly': 'Studio Minimum Weekly Floor ({cur})',
  'hybrid.floorMinHint': 'Studio receives commission, or this minimum weekly floor amount, whichever is higher',
  'hybrid.floorCalculated': 'Studio is guaranteed at least {cur}{amount}/month even during slow periods.',

  // ── SAVED PRESET SEED DATA (src/utils/calculator.ts) ────────
  'presetName.standard5050': 'Standard 50/50 Commission vs {cur}250 Booth',
  'presetName.cityCentre': 'Prime City Centre ({cur}350/wk vs 60/40 Split)',
  'presetName.hybrid': 'Hybrid: Base {cur}120/wk + 20% Studio Cut',
  'presetName.floorGuarantee': '50% Commission with {cur}220/wk Minimum Floor',

  // ── STUDIO CHAIR SEED DATA (src/utils/calculator.ts) ────────
  'chairName.seniorPiercer': 'Station 1 (Senior Piercer)',
  'chairName.bodyPiercer': 'Station 2 (Body Piercer)',
  'chairName.residentArtist': 'Station 3 (Resident Artist)',
  'chairName.juniorApprentice': 'Station 4 (Junior / Apprentice)',
  'chairName.guestFlex': 'Station 5 (Guest / Flex Chair)',

  // ── EXPORT FILE LABELS (src/utils/calculator.ts) ────────────
  'export.title': 'POLI INTERNATIONAL - BOOTH RENT VS COMMISSION CALCULATION EXPORT',
  'export.generated': 'Generated: {date}',
  'export.sectionCore': '--- CORE DEAL SUMMARY ---',
  'export.sectionInclusions': '--- INCLUSIONS RESPONSIBILITY MATRIX ---',
  'export.sectionSeasonality': '--- 12-MONTH SEASONALITY AND CASH FLOW ---',
  'export.sectionStudio': '--- STUDIO FLOOR CAPACITY PLANNER ---',
  'export.colMetric': "Metric",
  'export.colItem': "Item",
  'export.colCostOrRate': "Cost or Rate",
  'export.colBoothPayer': "Booth Payer",
  'export.colCommPayer': "Commission Payer",
  'export.colStation': "Station",
  'export.colWeeklyRent': "Weekly Rent",
  'export.colMonthlyRevenue': "Monthly Revenue",
  'export.rowStudioFee': "Studio Fee or Rent Monthly",
  'export.rowInclusionsTotal': "Inclusions and Supplies Total",
  'export.rowArtistRetained': "Artist Retained Percentage",
  'export.rowShopOverhead': "Shop Monthly Overhead",
  'export.rowOccupancyRate': "Occupancy Rate",
  'export.toolName': 'Booth Rent vs Commission Calculator V2',
};
